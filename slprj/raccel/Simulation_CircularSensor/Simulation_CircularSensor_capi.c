...
rtcapiStoredFloats [ ] = { 0.02 , 0.0 } ; static const rtwCAPI_FixPtMap
...
rtDimensionArray } , "float" , { 2114904436U , 959156056U , 3938450206U ,
3514021165U } , ( NULL ) , 0 , 0 } ; const rtwCAPI_ModelMappingStaticInfo *
