###########################################################################
## Makefile generated for MATLAB file/project 'TrimmingArray'. 
## 
## Makefile     : TrimmingArray_rtw.mk
## Generated on : Mon May 11 13:35:50 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: ./TrimmingArray.lib
...
PRODUCT_NAME              = TrimmingArray
MAKEFILE                  = TrimmingArray_rtw.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/robot/Documents/MATLAB/2020_RoboTrace/PathPlanning/C_code/codegen/lib/TrimmingArray
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = TrimmingArray_rtw_comp.rsp
CMD_FILE                  = TrimmingArray_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = TrimmingArray.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=TrimmingArray
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=TrimmingArray
...
SRCS = $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c $(START_DIR)/TrimmingArray_data.c $(START_DIR)/TrimmingArray_initialize.c $(START_DIR)/TrimmingArray_terminate.c $(START_DIR)/TrimmingArray.c $(START_DIR)/TrimmingArray_emxutil.c $(START_DIR)/TrimmingArray_emxAPI.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o TrimmingArray_data.o TrimmingArray_initialize.o TrimmingArray_terminate.o TrimmingArray.o TrimmingArray_emxutil.o TrimmingArray_emxAPI.o
...
TrimmingArray_data.o : $(START_DIR)/TrimmingArray_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TrimmingArray_initialize.o : $(START_DIR)/TrimmingArray_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TrimmingArray_terminate.o : $(START_DIR)/TrimmingArray_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TrimmingArray.o : $(START_DIR)/TrimmingArray.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TrimmingArray_emxutil.o : $(START_DIR)/TrimmingArray_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TrimmingArray_emxAPI.o : $(START_DIR)/TrimmingArray_emxAPI.c
	$(CC) $(CFLAGS) -o "$@" "$<"
