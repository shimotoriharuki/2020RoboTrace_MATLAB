...
rtcapiStoredFloats [ ] = { 0.4 , 0.0 } ; static const rtwCAPI_FixPtMap
...
rtDimensionArray } , "float" , { 776680629U , 1304470307U , 2417145415U ,
4200155072U } , ( NULL ) , 0 , 0 } ; const rtwCAPI_ModelMappingStaticInfo *
